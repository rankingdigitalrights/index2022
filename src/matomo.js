...
// See: https://github.com/SocialGouv/sample-next-app/blob/master/src/matomo.js

export function matopush(args) {
  window._paq.push(args);
}
// Initialize the Matomo/Piwik tracker.
export function initMatomo({
  ...
  const refElement = document.querySelectorAll("script")[0];
