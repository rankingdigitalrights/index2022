        ...
        >
          <div className="font-serif flex flex-col h-full justify-end">
            <p>
              ...
              passing grade in our ranking. While we see some incremental
              progress overall, companies must improve their governance and
              accelerate their adoption of human rights standards to protect
              their users and the public interest.
            </p>
          </div>
        </HomeBox>
      </div>
          ...
          >
            <div className="font-serif hidden md:block flex flex-col h-full justify-end">
              <p>
                ...
                and recommendations, and learn why—more than ever—this is no
          ...
          >
            <div className="font-serif hidden md:block flex flex-col h-full justify-end">
              <p>
                ...
                describing how they moderate content? Where is your data safest
                in case of a breach? How has Apple’s scores changed over time?
                Drill down into hundreds of thousands of data points to answer
                questions like these in our enhanced Data Explorer.
              </p>
            </div>
          </HomeBox>
        </div>
